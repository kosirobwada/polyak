...
if __name__ == '__main__':
    ...
    # Model Preparation
    if model == "ResNet18":
        net = build_resnet(model_type="resnet18", dataset_name='CIFAR10')
        print("model: ResNet18")
    elif model == "WideResNet28_10":
        net = build_wide_resnet(model_type=model, dataset_name='CIFAR10')
    ...
    # Save to CSV file
    filename = f"../result/csv/CIFAR10/{model}/{case}/{lr_method}"
    if lr_method == "poly":
